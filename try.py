...
st.set_page_config(
    page_title="Klasifikasi Penyakit Tanaman Padi",
    page_icon=":leaves:",
    layout="wide",
...
with st.sidebar:
    st.markdown(
        """
        1. tekan tombol browse file dan fotokan daun tanaman padi  📷
        2. atau tekan tombol dan pilih gambar yang ingin diklasifikasi
        3. dan tunggu sesaat web bekerja  🚀
        """
    )
